...
void Scene::Draw2D()
{
	...
	// 文字列表示
	SHADER.m_spriteShader.DrawString(230, 350, "パーティクル２", Math::Vector4(0, 0, 0, 1));
	SHADER.m_spriteShader.DrawString(230+8, 350-5, "パーティクル２", Math::Vector4(1, 1, 0, frame / 180.0f));
